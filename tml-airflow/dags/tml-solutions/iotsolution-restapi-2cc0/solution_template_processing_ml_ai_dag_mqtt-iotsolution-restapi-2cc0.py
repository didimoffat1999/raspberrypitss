...
step3 = importlib.import_module("tml-solutions.iotsolution-restapi-2cc0.tml_read_MQTT_step_3_kafka_producetotopic_dag-iotsolution-restapi-2cc0")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_mqtt_dag-iotsolution-restapi-2cc0",
